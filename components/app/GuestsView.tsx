  ...
  return (
    <div className="px-4 py-6 md:px-8">
      ...
      {view === "cards" ? (
        ...
        <div className="rounded-lg border bg-background/72">
          <Table>
            <TableHeader>
              <TableRow>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="flex gap-1">
                          {CATEGORY_ORDER.filter((category) => tickets.some((ticket) => ticket.category === category && ticket.status !== "resolved")).map((category) => (
                            <span key={category} className="size-2 rounded-full" style={{ background: `var(${CATEGORY_META[category].colorVar})` }} />
                          ))}
                        </span>
                      </div>
                    </TableCell>
